    ...
    return (
        <div className="max-w-3xl mx-auto mt-12 px-6 py-8 bg-gray-900">
            ...
            <Form method='post' className="space-y-6">
                ...
                <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-gray-300">Subject <span className="text-red-500">*</span></label>
                ...
                <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-gray-300">Message <span className="text-red-500">*</span></label>

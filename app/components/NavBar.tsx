...
const Navbar = () => {
    ...
    const base = 'text-gray-300 transition hover:text-blue-400';
    const active = 'text-blue-400 font-semibold';

    return (<nav className="bg-gray-700 border-b border-gray-500 shadow-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className='hidden md:flex items-center gap-6 text-md text-gray-300 font-semibold'>
                ...
                <NavLink className={({ isActive }) => isActive ? active : base} to='/resume'>Resume</NavLink>
